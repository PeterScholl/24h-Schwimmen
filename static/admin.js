...
const CONFIG_SCHEMA = [
    ...
    { key: 'v3_timer_dauer_ms',             label: 'Klick-Verzögerung (ms)',          type: 'number',   group: 'v3',        desc: 'Wartezeit nach Kachelklick bis Aktion in Warteschlange landet' },
    { key: 'v3_sende_intervall_ms',        label: 'Sende-Intervall (ms)',            type: 'number',   group: 'v3',        desc: 'Intervall für automatisches Paket-Senden aller ausstehenden Aktionen — Standard: 30000' },
